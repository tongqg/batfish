...
public class BatfishTestUtils {
  ...
  private static Batfish initBatfish(
    ...
    DataPlanePlugin bdpDataPlanePlugin = new BdpDataPlanePlugin() {};
  ...
  private static Batfish initBatfish(
    ...
    if (!baseConfigs.isEmpty()) {
      ...
      settings
          ...
          .toFile()
          .mkdirs();
      testrigs.put(settings.getBaseTestrigSettings(), baseConfigs);
      testrigs.put(settings.getDeltaTestrigSettings(), deltaConfigs);
      settings.setActiveTestrigSettings(settings.getBaseTestrigSettings());
    }
    Batfish batfish =
        new Batfish(
